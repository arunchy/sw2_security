...
function VendorSignup() {
  ...
  const handleSubmitBtn = async () => {
    ...
    formValues.captcha=captchaValue;
      ...
      <div className='row my-4'>
        <div className='col-sm-6'>
          ...
          <div className='col-sm-6 my-2 d-flex'>
           ...
           <a href='/vendor/login' className='text-primary' style={{fontSize:"13px",textDecoration:"none"}}>Login</a>
          </div>
         </div>

         <div className='row d-flex align-items-center justify-content-center'>
         <div className='col-sm-6 my-2 d-flex'>
          <p className='mx-1' style={{fontSize:"13px"}}>Back to Home? </p>
          <a style={{fontSize:"13px",textDecoration:"none"}} 
          className='text-primary' href='/'>Home</a>
         </div>
         </div>
